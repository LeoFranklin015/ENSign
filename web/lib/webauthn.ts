...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://api.justaname.id'
const API_KEY = process.env.NEXT_PUBLIC_API_KEY || 'VJZaS2Pq14R4r1kIdBPV3NprnMeJGJED'
