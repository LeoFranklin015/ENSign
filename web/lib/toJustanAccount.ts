...
export async function sign({
  ...
  if (owner.type === 'webAuthn') {
    ...
    const wa = {
      ...
      challengeIndex: webauthn.challengeIndex ?? 0,
      typeIndex: webauthn.typeIndex ?? 0,
      userVerificationRequired: webauthn.userVerificationRequired ?? false,
    }
    return toWebAuthnSignature({ signature, webauthn: wa })
  }
