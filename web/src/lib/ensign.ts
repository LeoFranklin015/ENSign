...
export const REGISTRY = import.meta.env.VITE_REGISTRY as `0x${string}`;
export const ENTRYPOINT = import.meta.env.VITE_ENTRYPOINT as `0x${string}`;
export const PARENT_NAME = import.meta.env.VITE_PARENT_NAME as string;
export const RPC_URL = import.meta.env.VITE_RPC_URL as string;
export const BASE_SEPOLIA_RPC_URL = import.meta.env.VITE_BASE_SEPOLIA_RPC_URL as string;
export const PIMLICO_KEY = import.meta.env.VITE_PIMLICO_KEY as string;
